...
async function main() {
  ...
  const moreAthletes: {
    ...
    {
      sport: "soccer",
      slug: "soccer-lamine-yamal",
      athleteName: "Lamine Yamal",
      title: "Lamine Yamal's Daily Routine",
      excerpt: "17 years old, still living at home, and staying late after every team session for extra 1v1 and finishing work.",
      body: `<p><strong>Verified context:</strong> 17 years old, still lives at home with his parents in Esplugues de Llobregat (unusual for a pro at his level), trains at Barcelona's Ciutat Esportiva, joined La Masia at age 7.</p><h2>A Typical Day (reconstructed estimate, not confirmed)</h2><ul><li><strong>8:30 AM</strong> — Wake up, hydration, light stretching</li><li><strong>9:00 AM</strong> — Breakfast (eggs, toast, fruit, orange juice)</li><li><strong>10:30 AM</strong> — Individual warm-up: dribbling, acceleration drills</li><li><strong>10:45 AM</strong> — Full team training</li><li><strong>12:45 PM</strong> — Extra individual technical work (1v1s, finishing)</li><li><strong>1:15 PM</strong> — Recovery: physio, stretching, light cold therapy</li><li><strong>2:00 PM</strong> — Lunch (performance meal)</li><li><strong>~4:00 PM</strong> — Afternoon nap (~90 min, estimated)</li><li><strong>9:00 PM</strong> — Family dinner</li><li><strong>12:15 AM</strong> — Sleep</li></ul><h2>What Stands Out</h2><p><strong>Extra self-driven training.</strong> Staying after team sessions for individual technical work is a genuinely documented habit, not just speculation — coaches and teammates have specifically noted it.</p><p><strong>9–10 hours of sleep target</strong>, appropriate for a still-developing teenage body, plus a long afternoon nap.</p><p><strong>Living at home</strong> — a real, notable difference from most top-level pros his age, who typically move out on their own.</p>`,
    },
    {
      sport: "soccer",
      slug: "soccer-kylian-mbappe",
      athleteName: "Kylian Mbappé",
      title: "Kylian Mbappé's Routine",
      excerpt: "A 5-day weight-training split, 3x/week ab work, and a 6-meal-a-day diet built around lean protein and steady carbs.",
      body: `<h2>Weight Training (5 days/week)</h2><ul><li><strong>2 Leg Days</strong> — squats, deadlifts, walking lunges, Bulgarian squats, hip thrusts</li><li><strong>Shoulders Day</strong> — dumbbell presses, lateral raises, cable upright rows</li><li><strong>Back &amp; Biceps Day</strong> — pull-ups, lat pulldowns, rows, curls</li><li><strong>Chest &amp; Triceps Day</strong> — bench press, push-ups, dips, triceps pushdowns</li></ul><h2>Ab Training (3x/week, after lifting)</h2><ul><li>Crunches, planks, leg raises, scissor kicks</li></ul><h2>Diet — 6 Meals/Day</h2><ol><li>Breakfast: boiled eggs + avocado/almond butter + porridge</li><li>Snack: protein bar</li><li>Lunch: tuna or chicken wrap + salad</li><li>Snack: protein shake + fruit</li><li>Dinner: chicken or fish + brown rice + vegetables</li><li>Evening: protein shake</li></ol>`,
    },
    {
      sport: "soccer",
      slug: "soccer-diego-maradona",
      athleteName: "Diego Maradona",
      title: "Maradona's (Imagined) Coaching Philosophy — Simplified",
      excerpt: "A speculative reconstruction of what Maradona's coaching principles might look like — technical skill, flair, and competitive fire above all.",
      body: `<p><em>This is a speculative piece imagining Maradona's coaching philosophy, not a documented program he personally ran.</em></p><h2>7 Core Principles</h2><ol><li><strong>Technical skills first</strong> — dribbling through cones, juggling, varied passing and shooting</li><li><strong>Football intelligence</strong> — teaching players to read the game, scan constantly, and understand tactics/positioning</li><li><strong>Creativity and flair</strong> — encouraging risk-taking, individual moves, and self-expression rather than "safe" play</li><li><strong>Work ethic and discipline</strong> — consistent practice and long-term focus</li><li><strong>Mental toughness</strong> — using his own real struggles/setbacks as a teaching tool for resilience</li><li><strong>Teamwork</strong> — despite his individual brilliance, emphasizing that his game was never selfish</li><li><strong>Competitive fire</strong> — instilling a refusal to settle for anything less than excellence</li></ol><h2>Specific Training Elements (imagined)</h2><ul><li>Heavy use of 1v1 duels and small-sided games to force creative decision-making</li><li>Rondos and scanning drills for spatial awareness</li><li>Practicing signature moves/feints (like the "Maradona turn") deliberately, not just organically</li></ul>`,
    },
    {
      sport: "soccer",
      slug: "soccer-trent-alexander-arnold",
      athleteName: "Trent Alexander-Arnold",
      title: "How Trent Alexander-Arnold Trains: A Day in the Life of a Modern Full-Back",
      excerpt: "Five and a half hours a day at the training centre, plus a 12-week vision-training program with a sports ophthalmologist.",
      body: `<p>Few positions in modern football have been redefined as dramatically as the full-back — and few players are more responsible for that shift than Trent Alexander-Arnold. Once viewed as a purely defensive role, the modern full-back is now expected to defend, create, and finish, often in the same sequence. Alexander-Arnold's own training routine reflects that evolution: less about traditional defensive drilling, more about building an athlete who can do everything.</p><h2>A Five-and-a-Half-Hour Training Day</h2><p>In his own words, shared through Red Bull, Alexander-Arnold has described just how much time a Premier League training day actually takes up: "Trent spends over five hours a day at the training centre," with the schedule built entirely around match timing. As he put it: "We train when we play. So, if we're playing at 4.30pm the following day, we'll train at 4.30pm, which means we're in for 2.30pm and leaving at 7pm." In total, that adds up to roughly five and a half hours at the training ground on a typical day.</p><p>The week isn't uniform in intensity, either. Training gradually ramps up as the week progresses, but the day before a match shifts to something much lighter — mostly tactical and low-intensity, focused on information rather than physical output. With Liverpool often playing two or three matches a week, his week essentially alternates between playing and recovering, leaving little room for anything else.</p><h2>The Role of the Coaching Staff</h2><p>Alexander-Arnold has also spoken about how sessions are actually built: assistant coach Pep Lijnders sets out and explains the training sessions, with the manager overseeing the overall program — reflecting how modern top-flight clubs divide coaching responsibilities between specialized assistants rather than a single head coach running every drill.</p><h2>The More Unusual Piece: Vision Training</h2><p>Beyond conventional physical training, Alexander-Arnold has done something few footballers have: dedicated training specifically for his eyesight and visual processing. Partnering with Red Bull, he worked with Dr. Daniel Laby, a sports ophthalmologist who has worked with NFL and NBA teams, becoming the first footballer in the English game to undertake this kind of program. The training focused on reaction time, visual tracking, and peripheral vision — skills he described as directly tied to decision-making speed on the pitch: "The clearer I can see, and the more I can see — judging things like the position of opposition players quicker — the better the decision I can make on the pitch." He committed to the intervention for 12 weeks, working through it during a stretch when a Euros injury had sidelined him from international duty.</p><h2>Why This Matters for a Full-Back Specifically</h2><p>Alexander-Arnold's game is built on delivering the right pass at the right moment, at pace, often under pressure — arguably more reliant on the split-second read of a developing play than almost any other position on the pitch. Vision and reaction-time training is a natural fit for a player whose defining skill isn't raw physical dominance, but precision decision-making delivered faster than the player marking him can react.</p>`,
    },
    {
      sport: "soccer",
      slug: "soccer-erling-haaland",
      athleteName: "Erling Haaland",
      title: "Erling Haaland: What's Actually Behind the Numbers",
      excerpt: "Mobility over raw power, functional strength over bodybuilding, and a home ice bath, sauna, and cryotherapy setup for recovery.",
      body: `<p>At 6'5", capable of sprinting up to 35 km/h, and averaging over a goal a game across three-plus seasons at Manchester City, Erling Haaland doesn't just look different from most strikers — he trains differently too.</p><h2>The Foundation: Mobility, Not Just Power</h2><p>Given his size, it would be easy to assume Haaland's game is built purely on strength. It isn't. He's described his most acrobatic, unusual finishes as a product of flexibility rather than power, and treats mobility work as a standalone daily pillar — not a warm-up afterthought — guided by a dedicated Manchester City therapist, done on both match days and rest days alike. Exercise scientist Dr. Mike Israetel, who conducted a detailed public analysis of Haaland's training, backed this up directly, noting that better mobility correlates with lower injury rates and greater physical capability.</p><h2>Strength and Conditioning: Functional, Not Bodybuilding-Style</h2><p>Haaland's approach favors speed, agility, and raw endurance over heavy bodybuilding-style lifting. His conditioning work includes treadmill sessions, cycling, rowing, and HIIT sprints, while strength training leans on functional movements and bodyweight work rather than pure hypertrophy training. His former RB Salzburg coach, Stanislav Macek, has stated Haaland did 300 press-ups and 1,000 sit-ups a day during that stage of his development.</p><h2>Recovery: Where He Goes Furthest</h2><p>If there's one area where Haaland is genuinely unusual, it's recovery. He's installed a home ice bath, sauna, and even a cryotherapy setup, and has described using red light therapy specifically to compensate for the lack of sunlight in Manchester. He's stated in multiple interviews that sleep is the most important factor in his performance and treats a consistent sleep schedule as non-negotiable.</p><h2>Nutrition: The "Eat Like a Viking" Reputation</h2><p>Haaland's diet, built with a nutritionist alongside his father and mentor, former Premier League defender Alf-Inge Haaland, leans on whole, minimally processed foods — steaks, eggs, fish, and notably organ meats like heart and liver. Pasta is a go-to pre-match meal for accessible carbs, salmon is a favorite for its protein and omega-3 content, and his father reportedly cooks him lasagne before every home match.</p><h2>The Honest Caveat</h2><p>Dr. Israetel's assessment is deliberately mixed: some of Haaland's methods (mobility work, smart strength training, a focus on durability) are genuinely worth learning from, but some of it is likely just harmless ritual, and a few habits may not be doing anything measurable at all. Copying a world-class athlete's routine wholesale is a mistake — elite performance comes from an entire career of accumulated training, genetics, and skill, not any single habit in isolation.</p>`,
    },
  ];
