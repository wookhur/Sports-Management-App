// Small original flat-style illustration for the Roy intro screen — a
// generic coach silhouette (cap + clipboard), not a copy of any reference art.
export default function RoyAvatar() {
  return (
    <svg viewBox="0 0 200 200" className="mx-auto h-48 w-48" aria-hidden="true">
      <circle cx="100" cy="100" r="96" fill="#134e4a" />
